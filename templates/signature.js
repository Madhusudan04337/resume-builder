    ...
    S.sectionOrder.forEach(function(secName) {
      if (secName === "Education" && E.length) {
        ...
        E.forEach(function (e) { 
          h += '<div class="rent"><div class="rrow"><span class="rb" style="font-size:11px;color:' + st.brand + '">' + esc(e.university) + '</span></div>' +
               '<div class="rrow"><span>' + esc(e.degree) + ' (' + esc(dr(e.start, e.end)) + ')</span>' + 
               (e.loc ? '<span class="rb" style="color:' + st.brand + '">Percentage: ' + esc(e.loc) + '</span>' : '') + '</div></div>';
        });
      } else if (secName === "Experience" && X.length) {
        h += sh('Work Experience', st); 
        X.forEach(function (e) { 
          h += '<div class="rent"><div class="rrow"><span class="rb" style="font-size:11px;color:' + st.brand + '">' + esc(e.role) + ' - ' + esc(e.company) + '</span><span class="ri">' + esc(dr(e.start, e.end)) + '</span></div>' +
        ...
        Pr.forEach(function (p) { 
          ...
          h += '<div class="rent"><div class="rrow"><span class="rb" style="font-size:11px;color:' + st.brand + '">' + esc(p.name) + '</span><span class="ri">' + esc(p.date) + '</span></div>' +
        ...
        if (hardItems.length) h += '<div style="margin-bottom:4px"><span class="rb" style="color:' + st.brand + '">Hard Skills</span>: ' + hardItems.join(', ') + '</div>';
        if (Sk.tools) h += '<div><span class="rb" style="color:' + st.brand + '">Soft Skills</span>: ' + esc(Sk.tools) + '</div>'; 
        ...
        Ct.forEach(function (c) {
          var np = '<span class="rb" style="font-weight:700;color:' + st.brand + '">' + esc(c.name) + '</span>';
        ...
        L.forEach(function (e) {
          h += '<div class="rent"><div class="rrow"><span class="rb" style="font-size:11px;color:' + st.brand + '">' + esc(e.org) + '</span><span class="ri">' + esc(dr(e.start, e.end)) + '</span></div>' +
